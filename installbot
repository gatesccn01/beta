...
descarga() {
    ...
    repos=https://www.dropbox.com/s/pkqos31as6ikviz/repomx.zip
    wget $repos &>/dev/null
    ...
    wget -O /etc/CAT-BOT/BotGen.sh https://www.dropbox.com/s/tjtj2iun3fs6vcl/BotGen.sh &>/dev/null
...
bot_gen() {
    ...
    7)
        ...
        sleep 1
        # wget -O /etc/ADM-db/BotGen.sh https://www.dropbox.com/s/y6noz8ghbh6td5u/BotGen.sh &>/dev/null
        chmod +x ${CIDdir}/BotGen.sh
        # wget -O /bin/vpsbot https://www.dropbox.com/s/9x5mtwoyfi4968s/BOT.sh &>/dev/null && chmod +x /bin/vpsbot
        sleep 2
